...
class GoodsFragment : Fragment() {
    ...
    private fun processSearch() {
        ...
        reqMap["group"] = if ((goodsGroupSpinner?.selectedItem as GoodsGroup) != null) (goodsGroupSpinner?.selectedItem as GoodsGroup).id else null
    ...
    private fun makeGood() : Good {
        ...
        good.group = if ((goodsGroupSpinner?.selectedItem as GoodsGroup) != null) (goodsGroupSpinner?.selectedItem as GoodsGroup).id else null
        return good
    }
